                    ...
                    <tbody class="table-body">
                        ...
                        foreach ($clan_rank as $row) :
                            ...
                            <tr>
                                ...
                                <td data-input="game">
                                    <div class="info game-name"><img src="<?php echo base_url() ?>assets/main/assets/images/img_clan/<?php echo $row['clan_rank'] ?>.jpg" alt="<?php echo $row['clan_rank'] ?>"></div>
                                </td>
                            </tr>
                            <?php
                        endforeach;
