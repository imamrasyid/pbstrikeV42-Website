    ...
    <div class="container">
        <div class="account-wrapper">
            <div class="account-area">
                ...
                <?php echo form_open(base_url('login/lupa_password'), 'class="account-form"') ?>
                ...
                ?>
                    ...
                    <div class="account-form-group">
                        <input type="text" name="hint_answer" placeholder="Jawaban Hint (Tetap Jaga Kerahasiaan Hint Anda)" value="<?php echo set_value('hint_answer') ?>" required>
                    </div>
                    <div class="account-form-group">
